...
Fonts live in `/assets/fonts` and are hashed into the trace as well:
...
Licence text for both faces: `/assets/fonts/licenses/ofl-pt.txt`.

## Browser

Chromium comes from `playwright@1.55.0`, installed into `.browsers/` via
