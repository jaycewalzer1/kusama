...
import { SELF_SCORE_FLOOR, finishBlockers, requiredStrings, unreadable } from '../artist/gate.js';
...
import type { Brief } from '../artist/field.js';
import type { Examine } from '../artist/types.js';
